document.addEventListener('DOMContentLoaded', () => {
    ...
    for ( var i = 0, len = squares.length; i < len; i++) {
        ...
        (
            function(index) {
                // Добавляем клик на каждый квадрат в вашей сетке.
                squares[i].onclick = function() {
                    // Если квадрат под вашим текущим квадратом взят, вы можете пойти поверх него.
    ...
    // Проверить доску на выигрыш или проигрыш
    ...
    function checkBoard() {
        ...
        // Теперь берем 4 значения и вставляем их в значения квадратов
        ...
        for (let y = 0; y < winningArrays.length; y++) {
            ...
            // Теперь проверим эти массивы, все ли они имеют класс player-one
            ...
            // Теперь проверим эти массивы, все ли они имеют класс player-two
            else if 
